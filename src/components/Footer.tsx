...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#18141a] text-white/90 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-[8px] tracking-[0.35em] uppercase text-[#f7a8c4] font-bold mt-1">Events &amp; Communications</div>
              </div>
            </div>
            <p className="text-sm leading-relaxed font-normal text-white/90 max-w-xs">
          ...
          {/* Quick links */}
          <div>
            <h4 className="font-display text-lg text-white font-normal mb-5">Explore</h4>
              ...
              {[
                ...
                <li key={link.href}>
                  <button
                    ...
                    data-cursor-hover
                    className="text-sm text-white/85 hover:text-[#f7a8c4] font-medium transition-colors nav-link"
                  >
                    {link.label}
                  </button>
                </li>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-display text-lg text-white font-normal mb-5">Contact</h4>
            <ul className="space-y-4 text-sm font-medium">
              <li className="flex items-start gap-3 group">
                <Phone className="text-[#f7a8c4] shrink-0 mt-0.5 group-hover:scale-110 transition-transform" size={16} />
                <a href="tel:+251956535210" className="text-white/90 hover:text-[#f7a8c4] transition-colors" data-cursor-hover>+251 956 535 210</a>
              </li>
              <li className="flex items-start gap-3 group">
                <MessageCircle className="text-[#ffd97d] shrink-0 mt-0.5 group-hover:scale-110 transition-transform" size={16} />
                <a href="https://wa.me/251911715064" className="text-white/90 hover:text-[#ffd97d] transition-colors" data-cursor-hover>+251 911 715 064</a>
              </li>
              <li className="flex items-start gap-3 group">
              ...
              <li className="flex items-start gap-3 group">
                ...
                <span className="text-white/90">22 next to Zerihun building, IPS building 2nd floor, Addis Ababa</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/15 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <p className="text-xs text-[#f7a8c4] font-display italic">
