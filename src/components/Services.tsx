...
const services = [
  { icon: Heart, title: 'Wedding Planning', desc: 'From intimate ceremonies to grand celebrations, we craft weddings that tell your unique love story.', img: '/custom_offer_wedding.jpg', tag: 'Love & Celebration' },
