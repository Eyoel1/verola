...
const services = [
  { icon: Heart, title: 'Wedding Planning', desc: 'From intimate ceremonies to grand celebrations, we craft weddings that tell your unique love story.', img: '/velora_gg_5858.jpg', tag: 'Love & Celebration' },
  { icon: Briefcase, title: 'Corporate Events', desc: 'High-impact conferences, launches, and galas that elevate your brand and impress every stakeholder.', img: '/velora_gg_5866.jpg', tag: 'Business Excellence' },
  { icon: Palette, title: 'Decoration', desc: 'Impeccable styling and floral artistry that transforms any venue into a breathtaking setting.', img: '/velora_gg_5962.jpg', tag: 'Spatial Artistry' },
  { icon: Utensils, title: 'Catering', desc: 'Exquisite cuisine blending Ethiopian flavors with international gastronomy for memorable dining.', img: '/velora_gg_5890.jpg', tag: 'Culinary Excellence' },
  { icon: Building2, title: 'Venue Setup', desc: 'Complete venue transformation, from seating and staging to lighting and ambiance.', img: '/velora_gg_5886.jpg', tag: 'Full Transformation' },
